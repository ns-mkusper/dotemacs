...
(setq lsp-enabled-major-modes '(zig-mode rust-mode rustic-mode python-mode go-mode java-mode c++-mode sh-mode c-mode terraform-mode shell-script-mode kotlin-mode ;; pascal-mode
             ))
